...
public class ExtendSubsystem extends SubsystemBase {
    ...
    {
        // limitSwitch_di = new DigitalInput(5);
        ...
        // nt_extend_switch = tab.add("extend_switch_read",0).getEntry();
    ...
    public void periodic() 
    {
        ...
        // if(extend_switch==true)
        // {
        //    nt_extend_switch.setDouble( 1 );
        // }
        // else
        // {
        //     nt_extend_switch.setDouble( 0 );
        // }
    ...
    {
        return 0.0; //( nt_extend_set.getDouble( 0 ) );
    }
    ...
    public double getPosition(){
        return 0.0; //(nt_extend_pos.getDouble(0));
    }

    public boolean atPosition()
    {
        return false; //( Math.abs( nt_extend_pos.getDouble(0) - extendPosition ) < ExtendConstants.EXTEND_TOLERANCE );
    }
