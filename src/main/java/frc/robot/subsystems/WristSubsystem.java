...
public class WristSubsystem extends SubsystemBase {
    ...
    public double getPosition(){
        return 0.0; //(nt_wrist_pos.getDouble(0));
    }

    public double getWristOutput()
    {
        return 0.0; //( nt_wrist_set.getDouble( 0 ) );
    }
    
    public boolean atPosition()
    {
        return false; //( Math.abs( nt_wrist_pos.getDouble(0) - wristPosition ) < WristConstants.WRIST_TOLERANCE );
    }
